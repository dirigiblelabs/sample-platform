...
const viewData = { // This must always be called 'viewData'
    id: 'exampleViewCenter', // Unique view ID
    label: 'Center view', // View label
    region: 'center', // The layout region in which this view will be shown
    path: '/services/web/platform-samples/views/view-center.html', // Link to the main html file
